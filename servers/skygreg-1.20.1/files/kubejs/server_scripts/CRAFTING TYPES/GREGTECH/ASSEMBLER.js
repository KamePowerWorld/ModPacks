...
// basic_water_generator

event.remove ({ output: 'simplefluidgenerators:basic_water_generator'})
event.recipes.gtceu.assembler('kubejs:assembler/basic_water_generator')
...
.itemOutputs('simplefluidgenerators:basic_water_generator')
.duration(200)
.EUt(LV)
.circuit(1)

// basic_lava_generator

event.remove ({ output: 'simplefluidgenerators:basic_lava_generator'})
event.recipes.gtceu.assembler('kubejs:assembler/basic_lava_generator')
.itemInputs('4x #forge:plates/iron')
.itemInputs('2x #forge:glass/colorless')
...
// stone_lava_source_furnace

event.remove ({ output: 'lava_source:stone_lava_source_furnace'})
event.recipes.gtceu.assembler('kubejs:assembler/stone_lava_source_furnace')
.itemInputs('4x #forge:plates/iron')
.itemInputs('2x #forge:glass/colorless')
.itemInputs('minecraft:lava_bucket')
.itemInputs('minecraft:lava_bucket')
.inputFluids(Fluid.of('gtceu:rubber', 576))
.itemOutputs('lava_source:stone_lava_source_furnace')
.duration(200)
.EUt(LV)
.circuit(2)

// iron_lava_source_furnace

event.remove ({ output: 'lava_source:iron_lava_source_furnace'})
event.recipes.gtceu.assembler('kubejs:assembler/iron_lava_source_furnace')
.itemInputs('lava_source:stone_lava_source_furnace')
.inputFluids(Fluid.of('gtceu:invar', 1296))
.itemInputs('4x #forge:plates/iron')
.itemOutputs('lava_source:iron_lava_source_furnace')
.duration(200)
.EUt(LV)
.circuit(2)

// gold_lava_source_furnace

event.remove ({ output: 'lava_source:gold_lava_source_furnace'})
event.recipes.gtceu.assembler('kubejs:assembler/gold_lava_source_furnace')
.itemInputs('lava_source:iron_lava_source_furnace')
.itemInputs('4x #forge:plates/gold')
.inputFluids(Fluid.of('gtceu:electrum', 1296))
.itemOutputs('lava_source:gold_lava_source_furnace')
.duration(200)
.EUt(MV)
.circuit(2)

// diamond_lava_source_furnace

event.remove ({ output: 'lava_source:diamond_lava_source_furnace'})
event.recipes.gtceu.assembler('kubejs:assembler/diamond_lava_source_furnace')
.itemInputs('lava_source:gold_lava_source_furnace')
.itemInputs('4x #forge:plates/diamond')
.inputFluids(Fluid.of('gtceu:aluminium', 1296))
.itemOutputs('lava_source:diamond_lava_source_furnace')
.duration(200)
.EUt(HV)
.circuit(2)
...
event.recipes.gtceu.assembler('kubejs:assembler/water_source_tier_1')
.itemInputs('4x #forge:plates/iron')
.itemInputs('2x #forge:glass/colorless')
.itemInputs('minecraft:water_bucket')
.itemInputs('minecraft:water_bucket')
.inputFluids(Fluid.of('gtceu:rubber', 576))
.itemOutputs('watersources:water_source_tier_1')
.duration(200)
.EUt(LV)
.circuit(2)
...
event.remove ({ output: 'watersources:iron_upgrade'})
event.recipes.gtceu.assembler('kubejs:assembler/iron_upgrade')
.itemInputs('#forge:plates/iron')
.itemInputs('#forge:foils/bronze')
.itemInputs('#forge:glass_panes/colorless')
.inputFluids(Fluid.of('gtceu:rubber', 144))
.itemOutputs('watersources:iron_upgrade')
.duration(100)
.EUt(ULV)

// gold_upgrade

event.remove ({ output: 'watersources:gold_upgrade'})
event.recipes.gtceu.assembler('kubejs:assembler/gold_upgrade')
.itemInputs('#forge:plates/gold')
.itemInputs('#forge:foils/steel')
.itemInputs('#forge:glass_panes/colorless')
.inputFluids(Fluid.of('gtceu:rubber', 144))
.itemOutputs('watersources:gold_upgrade')
.duration(100)
.EUt(LV)

// diamond_upgrade

event.remove ({ output: 'watersources:diamond_upgrade'})
event.recipes.gtceu.assembler('kubejs:assembler/diamond_upgrade')
.itemInputs('#forge:plates/diamond')
.itemInputs('#forge:foils/aluminium')
.itemInputs('#forge:glass_panes/colorless')
.inputFluids(Fluid.of('gtceu:rubber', 144))
.itemOutputs('watersources:diamond_upgrade')
.duration(100)
.EUt(MV)

// netherite_upgrade

event.remove ({ output: 'watersources:netherite_upgrade'})
event.recipes.gtceu.assembler('kubejs:assembler/netherite_upgrade')
.itemInputs('#forge:ingots/netherite')
.itemInputs('#forge:foils/stainless_steel')
.itemInputs('#forge:glass_panes/colorless')
.inputFluids(Fluid.of('gtceu:rubber', 144))
.itemOutputs('watersources:netherite_upgrade')
.duration(100)
.EUt(HV)
...
event.remove ({ output: 'exocraft:energy_core'})
event.recipes.gtceu.assembler('kubejs:assembler/energy_core')
.itemInputs('4x #forge:fine_wires/electrum')
.itemInputs('4x #forge:fine_wires/red_alloy')
.itemInputs('4x enderio:conduit_binder')
.itemInputs('1x exocraft:redstone_circuit')
.itemInputs('1x gtceu:energium_dust')
.itemInputs('1x gtceu:hv_sensor')
.itemInputs('1x gtceu:red_alloy_plate')
.inputFluids(Fluid.of('gtceu:redstone', 288))
.itemOutputs('exocraft:energy_core')
.duration(100)
.EUt(HV)

// redstone_circuit

event.remove ({ output: 'exocraft:redstone_circuit'})
event.recipes.gtceu.assembler('kubejs:assembler/redstone_circuit')
.itemInputs('2x #forge:fine_wires/annealed_copper')
.itemInputs('2x #forge:fine_wires/red_alloy')
.itemInputs('2x laserio:logic_chip')
.itemInputs('4x gtceu:nand_chip')
.itemInputs('1x gtceu:iron_plate')
.inputFluids(Fluid.of('gtceu:redstone', 288))
.itemOutputs('exocraft:redstone_circuit')
.duration(100)
.EUt(HV)

// unit_atlas

event.recipes.gtceu.assembler('kubejs:assembler/unit_atlas')
.itemInputs('2x #forge:exquisite_gems/lazurite')
.itemInputs('1x #gtceu:circuits/ev')
.itemInputs('1x gtceu:plastic_circuit_board')
.inputFluids(Fluid.of('gtceu:polyethylene', 288))
.itemOutputs('exocraft:unit_atlas')
.duration(200)
.EUt(HV)

// unit_ogre

event.recipes.gtceu.assembler('kubejs:assembler/unit_ogre')
.itemInputs('2x #forge:exquisite_gems/red_garnet')
.itemInputs('1x #gtceu:circuits/ev')
.itemInputs('1x gtceu:plastic_circuit_board')
.inputFluids(Fluid.of('gtceu:polyethylene', 288))
.itemOutputs('exocraft:unit_ogre')
.duration(200)
.EUt(HV)

// unit_legion

event.recipes.gtceu.assembler('kubejs:assembler/unit_legion')
.itemInputs('2x #forge:exquisite_gems/amethyst')
.itemInputs('1x #gtceu:circuits/ev')
.itemInputs('1x gtceu:plastic_circuit_board')
.inputFluids(Fluid.of('gtceu:polyethylene', 288))
.itemOutputs('exocraft:unit_legion')
.duration(200)
.EUt(HV)

// unit_stryder

event.recipes.gtceu.assembler('kubejs:assembler/unit_stryder')
.itemInputs('2x #forge:exquisite_gems/yellow_garnet')
.itemInputs('1x #gtceu:circuits/ev')
.itemInputs('1x gtceu:plastic_circuit_board')
.inputFluids(Fluid.of('gtceu:polyethylene', 288))
.itemOutputs('exocraft:unit_stryder')
.duration(200)
.EUt(HV)

// unit_ion

event.recipes.gtceu.assembler('kubejs:assembler/unit_ion')
.itemInputs('2x #forge:exquisite_gems/olivine')
.itemInputs('1x #gtceu:circuits/ev')
.itemInputs('1x gtceu:plastic_circuit_board')
.inputFluids(Fluid.of('gtceu:polyethylene', 288))
.itemOutputs('exocraft:unit_ion')
.duration(200)
.EUt(HV)
...
event.recipes.gtceu.assembler('kubejs:assembler/tesseract')
.itemInputs('1x #forge:storage_blocks/ender_eye')
.itemInputs('1x gtceu:lv_emitter')
.itemInputs('1x gtceu:lv_sensor')
.itemInputs('1x gtceu:steel_frame')
.inputFluids(Fluid.of('gtceu:polyethylene', 1296))
.itemOutputs('1x tesseract:tesseract')
.duration(200)
.EUt(LV)
...
event.recipes.gtceu.assembler('kubejs:assembler/waystone')
.itemInputs('4x minecraft:stone_bricks')
.itemInputs('1x waystones:warp_stone')
.itemInputs('1x gtceu:steel_frame')
.inputFluids(Fluid.of('gtceu:concrete', 1152))
.itemOutputs('1x waystones:waystone')
.duration(200)
.EUt(LV)
.circuit(1)
...
event.recipes.gtceu.assembler('kubejs:assembler/mossy_waystone')
.itemInputs('4x minecraft:mossy_stone_bricks')
.itemInputs('1x waystones:warp_stone')
.itemInputs('1x gtceu:steel_frame')
.inputFluids(Fluid.of('gtceu:concrete', 1152))
.itemOutputs('1x waystones:mossy_waystone')
.duration(200)
.EUt(LV)
.circuit(1)
...
event.recipes.gtceu.assembler('kubejs:assembler/sandy_waystone')
.itemInputs('4x minecraft:chiseled_sandstone')
.itemInputs('1x waystones:warp_stone')
.itemInputs('1x gtceu:steel_frame')
.inputFluids(Fluid.of('gtceu:concrete', 1152))
.itemOutputs('1x waystones:sandy_waystone')
.duration(200)
.EUt(LV)
.circuit(1)
...
event.recipes.gtceu.assembler('kubejs:assembler/sharestone')
.itemInputs('3x minecraft:stone_bricks')
.itemInputs('1x waystones:warp_stone')
.itemInputs('1x gtceu:steel_frame')
.inputFluids(Fluid.of('gtceu:concrete', 1152))
.itemOutputs('1x waystones:sharestone')
.duration(200)
.EUt(LV)
.circuit(2)
...
event.recipes.gtceu.assembler('kubejs:assembler/portstone')
.itemInputs('3x minecraft:stone_bricks')
.itemInputs('3x minecraft:polished_andesite')
.itemInputs('1x waystones:warp_stone')
.itemInputs('2x gtceu:steel_frame')
.inputFluids(Fluid.of('gtceu:concrete', 1152))
.itemOutputs('1x waystones:portstone')
.duration(200)
.EUt(LV)
.circuit(2)
...
event.recipes.gtceu.assembler('kubejs:assembler/warp_plate')
.itemInputs('1x minecraft:stone_pressure_plate')
.itemInputs('4x waystones:warp_dust')
.itemInputs('1x minecraft:flint')
.inputFluids(Fluid.of('gtceu:concrete', 288))
.itemOutputs('1x waystones:warp_plate')
.duration(100)
.EUt(LV)
.circuit(1)
...
event.recipes.gtceu.assembler('kubejs:assembler/matter_receiver')
.itemInputs('1x gtceu:lv_sensor')
.itemInputs('1x waystones:warp_stone')
.itemInputs('1x rftoolsbase:machine_frame')
.inputFluids(Fluid.of('gtceu:rubber', 1296))
.itemOutputs('1x rftoolsutility:matter_receiver')
.duration(100)
.EUt(LV)
.circuit(1)
...
event.recipes.gtceu.assembler('kubejs:assembler/matter_transmitter')
.itemInputs('1x gtceu:lv_emitter')
.itemInputs('1x waystones:warp_stone')
.itemInputs('1x rftoolsbase:machine_frame')
.inputFluids(Fluid.of('gtceu:rubber', 1296))
.itemOutputs('1x rftoolsutility:matter_transmitter')
.duration(100)
.EUt(LV)
.circuit(1)
